...
public class BrokenLinks {
		...
		public static void main(String[] args) throws InterruptedException, MalformedURLException, IOException {
			...
			driver.get("https://stg-go.cowrks.team/");
...
if(allLinks.get(i).getAttribute("href")!=null&&(!allLinks.get(i).getAttribute("href").contains("tel"))&&(!allLinks.get(i).getAttribute("href").contains("mailto"))) {
